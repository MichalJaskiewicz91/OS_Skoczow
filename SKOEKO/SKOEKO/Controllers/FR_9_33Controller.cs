...
namespace SKOEKO.Controllers
{
    ...
    {
        private static string quantityDay = "FR_9_33_Raport_Dobowy";
        private static string quantityHour = "FR_9_33_Raport_Godzinowy";
        private static string quantityMonth = "FR_9_33_Raport_Miesięczny";
        ...
        public ActionResult FR_9_33_searchMonth()
        {
            return View();
        }
        ...
        [HttpPost]
        public void FR_9_33_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FR_9_33_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FR_9_33_resultMonth(Search find, string sumbit)
        {
