...
namespace SKOEKO.Controllers
{
    public class FIQRC_17_004Controller : Controller
    {
        ...
        private static string quantityMonth = "FIQRC_17_004_Raport_Miesięczny";
        ...
        public ActionResult FIQRC_17_004_searchHour()
        {
            return View();
        }
        public ActionResult FIQRC_17_004_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQRC_17_004_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQRC_17_004_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQRC_17_004_resultDay(Search find)
        {
        ...
        [HttpPost]
        public ActionResult FIQRC_17_004_resultHour(Search find)
        {
        ...
        [HttpPost]
        public ActionResult FIQRC_17_004_resultMonth(Search find, string sumbit)
        {
