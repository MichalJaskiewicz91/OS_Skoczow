...
{
    public class FIQRC_07_206Controller : Controller
    {
        private static string quantityDay = "FIQRC_07_206_Raport_Dobowy";
        private static string quantityHour = "FIQRC_07_206_Raport_Godzinowy";
        private static string quantityMonth = "FIQRC_07_206_Raport_Miesięczny";
        ...
        public ActionResult FIQRC_07_206_searchDay()
        {
            return View();
        }
        public ActionResult FIQRC_07_206_searchHour()
        {
            return View();
        }
        public ActionResult FIQRC_07_206_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQRC_07_206_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQRC_07_206_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQRC_07_206_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQRC_07_206_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQRC_07_206_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQRC_07_206] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQRC_07_206_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQRC_07_206_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQRC_07_206_resultMonth(Search find, string sumbit)
        {
