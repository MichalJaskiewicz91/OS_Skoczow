...
{
    public class DIR_08_401Controller : Controller
    {
        private static string quantityDay = "DIR_08_401_Raport_Dobowy";
        private static string quantityHour = "DIR_08_401_Raport_Godzinowy";
        private static string quantityMonth = "DIR_08_401_Raport_Miesięczny";
        ...
        public ActionResult DIR_08_401_searchDay()
        {
            return View();
        }
        public ActionResult DIR_08_401_searchHour()
        {
            return View();
        }
        public ActionResult DIR_08_401_saveSearchDay()
        {
            return View();
        }
        public ActionResult DIR_08_401_saveSearchHour()
        {
            return View();
        }
        public ActionResult DIR_08_401_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult DIR_08_401_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[DIR_08_401_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult DIR_08_401_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[DIR_08_401] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void DIR_08_401_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void DIR_08_401_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult DIR_08_401_resultMonth(Search find, string sumbit)
        {
