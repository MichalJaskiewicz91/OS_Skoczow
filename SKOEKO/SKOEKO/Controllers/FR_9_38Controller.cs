...
{
    public class FR_9_38Controller : Controller
    {
        private static string quantityDay = "FR_9_38_Raport_Dobowy";
        private static string quantityHour = "FR_9_38_Raport_Godzinowy";
        private static string quantityMonth = "FR_9_38_Raport_Miesięczny";
        ...
        public ActionResult FR_9_38_searchDay()
        {
            return View();
        }
        public ActionResult FR_9_38_searchHour()
        {
            return View();
        }
        public ActionResult FR_9_38_saveSearchDay()
        {
            return View();
        }
        public ActionResult FR_9_38_saveSearchHour()
        {
            return View();
        }
        public ActionResult FR_9_38_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FR_9_38_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_38_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FR_9_38_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_38] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FR_9_38_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FR_9_38_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FR_9_38_resultMonth(Search find, string sumbit)
        {
