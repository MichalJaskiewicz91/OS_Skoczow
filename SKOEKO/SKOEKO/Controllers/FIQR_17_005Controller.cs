...
{
    public class FIQR_17_005Controller : Controller
    {
        private static string quantityDay = "FIQR_17_005_Raport_Dobowy";
        private static string quantityHour = "FIQR_17_005_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_17_005_Raport_Miesięczny";
        ...
        public ActionResult FIQR_17_005_searchDay()
        {
            return View();
        }
        public ActionResult FIQR_17_005_searchHour()
        {
            return View();
        }
        public ActionResult FIQR_17_005_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQR_17_005_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQR_17_005_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQR_17_005_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_17_005_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQR_17_005_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_17_005] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQR_17_005_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_17_005_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_17_005_resultMonth(Search find, string sumbit)
        {
