...
{
    public class FIQR_12_002Controller : Controller
    {
        private static string quantityDay = "FIQR_12_002_Raport_Dobowy";
        private static string quantityHour = "FIQR_12_002_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_12_002_Raport_Miesięczny";
        ...
        public ActionResult FIQR_12_002_searchDay()
        {
            return View();
        }
        public ActionResult FIQR_12_002_searchHour()
        {
            return View();
        }
        public ActionResult FIQR_12_002_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQR_12_002_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQR_12_002_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQR_12_002_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_12_002_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQR_12_002_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_12_002] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQR_12_002_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_12_002_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_12_002_resultMonth(Search find, string sumbit)
        {
