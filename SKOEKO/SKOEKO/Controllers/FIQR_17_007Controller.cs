...
namespace SKOEKO.Controllers
{
    public class FIQR_17_007Controller : Controller
    {
        ...
        private static string quantityMonth = "FIQR_17_007_Raport_Miesięczny";
        ...
        public ActionResult FIQR_17_007_searchMonth()
        {
            return View();
        }
        ...
        [HttpPost]
        public ActionResult FIQR_17_007_resultMonth(Search find, string sumbit)
        {
