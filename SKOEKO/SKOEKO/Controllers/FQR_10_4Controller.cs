...
namespace SKOEKO.Controllers
{
    ...
    {
        private static string quantityDay = "FQR_10_4_Raport_Dobowy";
        private static string quantityHour = "FQR_10_4_Raport_Godzinowy";
        private static string quantityMonth = "FQR_10_4_Raport_Miesięczny";
        ...
        public ActionResult FQR_10_4_searchMonth()
        {
            return View();
        }
        ...
        [HttpPost]
        public void FQR_10_4_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FQR_10_4_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FQR_10_4_resultMonth(Search find, string sumbit)
        {
