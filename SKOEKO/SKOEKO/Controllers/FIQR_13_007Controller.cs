...
{
    public class FIQR_13_007Controller : Controller
    {
        private static string quantityDay = "FIQR_13_007_Raport_Dobowy";
        private static string quantityHour = "FIQR_13_007_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_13_007_Raport_Miesięczny";
        ...
        public ActionResult FIQR_13_007_searchDay()
        {
            return View();
        }
        public ActionResult FIQR_13_007_searchHour()
        {
            return View();
        }
        public ActionResult FIQR_13_007_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQR_13_007_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQR_13_007_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQR_13_007_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_13_007_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQR_13_007_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_13_007] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQR_13_007_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_13_007_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_13_007_resultMonth(Search find, string sumbit)
        {
