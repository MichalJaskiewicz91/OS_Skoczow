...
namespace SKOEKO.Controllers
{
    public class FQR_7_10Controller : Controller
    {
        ...
        private static string quantityMonth = "FQR_7_10_Raport_Miesięczny";
        ...
        public ActionResult FQR_7_10_searchMonth()
        {
            return View();
        }
        ...
        [HttpPost]
        public ActionResult FQR_7_10_resultMonth(Search find, string sumbit)
        {
