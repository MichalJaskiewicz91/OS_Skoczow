...
{
    public class DIR_07_202Controller : Controller
    {
        private static string quantityDay = "DIR_07_202_Raport_Dobowy";
        private static string quantityHour = "DIR_07_202_Raport_Godzinowy";
        private static string quantityMonth = "DIR_07_202_Raport_Miesięczny";
        ...
        public ActionResult DIR_07_202_searchDay()
        {
            return View();
        }
        public ActionResult DIR_07_202_searchHour()
        {
            return View();
        }
        public ActionResult DIR_07_202_saveSearchDay()
        {
            return View();
        }
        public ActionResult DIR_07_202_saveSearchHour()
        {
            return View();
        }
        public ActionResult DIR_07_202_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult DIR_07_202_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[DIR_07_202_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult DIR_07_202_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[DIR_07_202] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void DIR_07_202_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
            ...
            {
                stringWriter = parseData.ParseDayDataDirCSV(reader);
            ...
            else
            {
                ...
                {
                    dataTable = parseData.ParseDayDataDirExcel(reader);
        ...
        [HttpPost]
        public void DIR_07_202_saveResultHour(Search find, string sumbit)
        {
            ...
            if (sumbit == "Zapisz do CSV")
            {
                stringWriter = parseData.ParseHourDataDirCSV(reader);
            ...
            else
            {
                using (XLWorkbook wb = new XLWorkbook())
                {
                    dataTable = parseData.ParseHourDataDirExcel(reader);
        ...
        [HttpPost]
        public ActionResult DIR_07_202_resultMonth(Search find, string sumbit)
        {
            ...
            if (sumbit == "Zapisz do Excel")
            {
                using (XLWorkbook wb = new XLWorkbook())
                {
                    dataTable = parseData.ParseMonthDataDirExcel(reader);
