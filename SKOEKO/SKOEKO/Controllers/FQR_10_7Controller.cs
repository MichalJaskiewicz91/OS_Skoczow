...
{
    public class FQR_10_7Controller : Controller
    {
        private static string quantityDay = "FQR_10_7_Raport_Dobowy";
        private static string quantityHour = "FQR_10_7_Raport_Godzinowy";
        private static string quantityMonth = "FQR_10_7_Raport_Miesięczny";
        ...
        public ActionResult FQR_10_7_searchDay()
        {
            return View();
        }
        public ActionResult FQR_10_7_searchHour()
        {
            return View();
        }
        public ActionResult FQR_10_7_saveSearchDay()
        {
            return View();
        }
        public ActionResult FQR_10_7_saveSearchHour()
        {
            return View();
        }
        public ActionResult FQR_10_7_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FQR_10_7_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FQR_10_7_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FQR_10_7_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FQR_10_7] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FQR_10_7_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FQR_10_7_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FQR_10_7_resultMonth(Search find, string sumbit)
        {
