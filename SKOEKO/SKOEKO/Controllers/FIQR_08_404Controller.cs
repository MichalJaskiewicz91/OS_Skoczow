...
namespace SKOEKO.Controllers
{
    ...
    {
        private static string quantityDay = "FIQR_08_404_Raport_Dobowy";
        private static string quantityHour = "FIQR_08_404_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_08_404_Raport_Miesięczny";
        ...
        public ActionResult FIQR_08_404_searchMonth()
        {
            return View();
        }
        ...
        [HttpPost]
        public void FIQR_08_404_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_08_404_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_08_404_resultMonth(Search find, string sumbit)
        {
