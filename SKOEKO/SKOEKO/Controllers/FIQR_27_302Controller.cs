...
{
    public class FIQR_27_302Controller : Controller
    {
        private static string quantityDay = "FIQR_27_302_Raport_Dobowy";
        private static string quantityHour = "FIQR_27_302_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_27_302_Raport_Miesięczny";
        ...
        public ActionResult FIQR_27_302_searchDay()
        {
            return View();
        }
        public ActionResult FIQR_27_302_searchHour()
        {
            return View();
        }
        public ActionResult FIQR_27_302_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQR_27_302_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQR_27_302_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQR_27_302_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_27_302_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQR_27_302_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_27_302] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQR_27_302_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_27_302_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_27_302_resultMonth(Search find, string sumbit)
        {
