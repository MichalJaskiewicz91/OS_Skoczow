...
{
    public class FR_9_36Controller : Controller
    {
        private static string quantityDay = "FR_9_36_Raport_Dobowy";
        private static string quantityHour = "FR_9_36_Raport_Godzinowy";
        private static string quantityMonth = "FR_9_36_Raport_Miesięczny";
        ...
        public ActionResult FR_9_36_searchDay()
        {
            return View();
        }
        public ActionResult FR_9_36_searchHour()
        {
            return View();
        }
        public ActionResult FR_9_36_saveSearchDay()
        {
            return View();
        }
        public ActionResult FR_9_36_saveSearchHour()
        {
            return View();
        }
        public ActionResult FR_9_36_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FR_9_36_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_36_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FR_9_36_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_36] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FR_9_36_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FR_9_36_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FR_9_36_resultMonth(Search find, string sumbit)
        {
