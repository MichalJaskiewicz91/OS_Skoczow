...
{
    public class FR_9_32Controller : Controller
    {
        private static string quantityDay = "FR_9_32_Raport_Dobowy";
        private static string quantityHour = "FR_9_32_Raport_Godzinowy";
        private static string quantityMonth = "FR_9_32_Raport_Miesięczny";
        ...
        public ActionResult FR_9_32_searchDay()
        {
            return View();
        }
        public ActionResult FR_9_32_searchHour()
        {
            return View();
        }
        public ActionResult FR_9_32_saveSearchDay()
        {
            return View();
        }
        public ActionResult FR_9_32_saveSearchHour()
        {
            return View();
        }
        public ActionResult FR_9_32_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FR_9_32_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_32_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FR_9_32_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_32] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FR_9_32_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FR_9_32_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FR_9_32_resultMonth(Search find, string sumbit)
        {
