...
{
    public class FIQRC_07_313Controller : Controller
    {
        private static string quantityDay = "FIQRC_07_313_Raport_Dobowy";
        private static string quantityHour = "FIQRC_07_313_Raport_Godzinowy";
        private static string quantityMonth = "FIQRC_07_313_Raport_Miesięczny";
        ...
        public ActionResult FIQRC_07_313_searchDay()
        {
            return View();
        }
        public ActionResult FIQRC_07_313_searchHour()
        {
            return View();
        }
        public ActionResult FIQRC_07_313_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQRC_07_313_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQRC_07_313_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQRC_07_313_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQRC_07_313_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQRC_07_313_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQRC_07_313] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQRC_07_313_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQRC_07_313_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQRC_07_313_resultMonth(Search find, string sumbit)
        {
