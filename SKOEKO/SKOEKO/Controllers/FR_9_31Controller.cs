...
{
    public class FR_9_31Controller : Controller
    {
        ...
        public ActionResult FR_9_31_searchHour()
        {
            return View();
        }
        public ActionResult FR_9_31_saveSearchDay()
        {
            return View();
        }
        ...
        [HttpPost]
        public ActionResult FR_9_31_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_31_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FR_9_31_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FR_9_31] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FR_9_31_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FR_9_31_saveResultHour(Search find, string sumbit)
        {
