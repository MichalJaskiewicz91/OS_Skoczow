...
{
    public class FIQR_12_003Controller : Controller
    {
        private static string quantityDay = "FIQR_12_003_Raport_Dobowy";
        private static string quantityHour = "FIQR_12_003_Raport_Godzinowy";
        private static string quantityMonth = "FIQR_12_003_Raport_Miesięczny";
        ...
        public ActionResult FIQR_12_003_searchDay()
        {
            return View();
        }
        public ActionResult FIQR_12_003_searchHour()
        {
            return View();
        }
        public ActionResult FIQR_12_003_saveSearchDay()
        {
            return View();
        }
        public ActionResult FIQR_12_003_saveSearchHour()
        {
            return View();
        }
        public ActionResult FIQR_12_003_searchMonth()
        {
            return View();
        }

        [HttpPost]
        public ActionResult FIQR_12_003_resultDay(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_12_003_Doba] WHERE Data > '" + odDateTime + "' AND Data < '" + endDateTime + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public ActionResult FIQR_12_003_resultHour(Search find)
        {
            ...
            String stm = "SELECT * FROM [dbo].[FIQR_12_003] WHERE Data > '" + odDateTime + "' AND Data < '" + reparsedTimeEnd + "'ORDER BY Data ASC";
        ...
        [HttpPost]
        public void FIQR_12_003_saveResultDay(Search find, string sumbit)
        {
            var od = find.from;
            var doo = find.to;
            var timeSt = find.timeStart;
        ...
        [HttpPost]
        public void FIQR_12_003_saveResultHour(Search find, string sumbit)
        {
        ...
        [HttpPost]
        public ActionResult FIQR_12_003_resultMonth(Search find, string sumbit)
        {
